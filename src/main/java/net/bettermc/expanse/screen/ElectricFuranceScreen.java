...
public class ElectricFuranceScreen extends HandledScreen<ElectricFuranceScreenHandler> {
    private static final Identifier TEXTURE =
            new Identifier(ExpanseMain.MOD_ID, "textures/gui/electric_furnace.png");

    public ElectricFuranceScreen(ElectricFuranceScreenHandler handler, PlayerInventory inventory, Text title) {
